...
![webcam channel switching buttons](.//webcam%20channel%20switcher.png)
...
![capture image button](.//capture%20image%20button.png)
...
![webcam preview](.//assembler%20image%20preview.png)
...
![recording control buttons](./start%20pause%20stop%20buttons.png)
...
![save preview window](.//save%20window%20overview.png)
...
![save location fields](.//save%20location.png)
